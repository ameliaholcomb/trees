...
//        Log.i("Connor", "Attempting to read in the file we just wrote");

//        File justWrote = new File("/data/user/0/com.google.ar.core.examples.java.sharedcamera/files/samples"+"/"+sampleFName);
//        if (!justWrote.exists()) {
//            Log.i("Connor", "The file does not exist!");
//        } else {
//            Log.i("Connor", "The file does exist!");
//        }

//        Log.i("Connor", "Listing all files in the directory");
//        File allDir = new File("/data/user/0/com.google.ar.core.examples.java.sharedcamera/files/samples");
//        File[] filesArray = allDir.listFiles();
